...
def Index1():
    ...
    cur.close()
    return render_template('index1.html', registration = data)
...
def add_registration():
    ...
    if request.method == 'POST':
        ...
        cur.execute("INSERT INTO registration (firstname,lastname,date,age,gender,rolno,email,address,phone,course,sem) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", (firstname,lastname,date,age,gender,rolno,email,address,phone,course,sem))
        conn.commit()
    ...
    if request.method == 'POST':
        ...
        cur.execute("""
            ...
            SET firstname = %s,
                ...
                sem = %s
            WHERE id = %s
        """, (firstname,lastname,date,age,gender,rolno,email,address,phone,course,sem,id))
